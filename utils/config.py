...
def add_data_group(group):
    ...
    group.add_argument('--mask_node_ratio', type=float, default=1.)
    group.add_argument('--mask_feat_ratio', type=float, default=0.05)
    group.add_argument('--mask_node_type', type=str, default='each_class')
    group.add_argument('--mask_feat_type', type=str, default='mask_by_dataset')
